...
const ColorPaletteModal = ({navigation}) => {
  ...
  const handleUpdate = useCallback(
    ...
    [selectedColors, setSelectedColors], // eslint-disable-line
  );
  ...
  }, [name, selectedColors]); // eslint-disable-line

  return (
    <View style={styles.container}>
      <View stye={styles.heading}>
        <Text style={styles.text}>Type a name for new color scheme</Text>
        <TextInput
          style={styles.input}
          prompt="Type a name for new color scheme"
          value={name}
